                                            ...
                                            <div class="col-lg-12 mb-2 origin">
                                                <div class="row">
                                                    <div class="col-lg-12 p-0">
                                                        <div class="bg-blue-900 text-white rounded-t font-bold py-1">
                                                            Ingredients
                                                        </div>
                                                        <div
                                                            class="bg-white rounded-b border-2 border-blue-900 p-3 table-responsive">
                                                            <table
                                                                class="table table-striped table-bordered table-hover w-100 mb-0 cursor-pointer">
                                                                <thead class="text-white bg-blue-800">
                                                                    <tr>
                                                                        <th class="p-1">Name</th>
                                                                        <th class="p-1">Concentration</th>
                                                                        <th class="p-1">Role</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody id="productIngredient">
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.product.ingredients.length != 0) {
                    for (let i = 0; i < res.product.ingredients.length ; i++){ $('#productIngredient').append( `<tr>
                        <td class="align-middle p-1">${res.product.ingredients[i].name}</td>
                        <td class="align-middle p-1">${res.product.ingredients[i].pivot.concentration ? res.product.ingredients[i].pivot.concentration : 'N/A'}</td>
                        <td class="align-middle p-1">${res.product.ingredients[i].pivot.role ? res.product.ingredients[i].pivot.role : ''}</td>
                    </tr>`)}
                } else {
