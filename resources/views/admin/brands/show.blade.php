...
@section('content')
    ...
    <section class="content-header flex justify-between">
        ...
        <div>
            ...
            {{-- <a href="{{route('admin.brands.index')}}" class="btn btn-primary font-bold inline-block items-center"><i class="fas fa-backward fa-xs inline-block my-auto mr-2"></i> Back To Brands</a> --}}
        </div>
    </section>
    <!-- Main content -->
